...
- **AI changelogs on demand.** Standup turns the completed work from any selected day into concise Added, Changed, Fixed, and Security notes using a fresh isolated provider session, with an optional default prompt saved for each project.
